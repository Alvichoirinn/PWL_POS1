...
class BarangController extends Controller
{
    ...
    {
        $request->validate([
            'kategori_nama' => 'required|exists:m_kategori,kategori_nama',
    ...
    {
        $request->validate([
            'kategori_id' => 'required|exists:m_kategori,kategori_nama',
    ...
    public function confirm_ajax(string $id)
    {
        ...
        return view('barang.confirm_ajax', ['barang' => $barang, 'kategori' => $barang->kategori]);
    }
