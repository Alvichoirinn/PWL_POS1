            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $level->level_kode }}" type="text" name="level_kode" class="form-control" required>
                        <small id="error-level_kode" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Nama Level</label>
                        <input value="{{ $level->level_nama }}" type="text" name="level_nama" class="form-control" required>
