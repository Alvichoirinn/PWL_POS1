...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Daftar Data Level</h3>
            <div class="card-tools">
                ...
                <a href="{{ url('/level/export_pdf') }}" class="btn btn-warning"><i class="fa fa-file-pdf"></i> Export Data Level</a>
...
$(document).ready(function(){
    tableLevel = $('#table-barang').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            "url": "{{ url('level/list') }}",
            ...
            "type": "POST",
            "data": function (d) {
                d.filter_level = $('.filter_kategori').val();
            }
        },
        columns: [{
                data: "DT_RowIndex", 
